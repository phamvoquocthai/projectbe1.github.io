...
-- Thời gian đã tạo: Th6 18, 2021 lúc 02:38 PM
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `amount_evalute` int(11) NOT NULL,
  `medium_point` double NOT NULL,
  `status` int(11) NOT NULL,
  PRIMARY KEY (`id`),
