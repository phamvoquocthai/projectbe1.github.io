...
$productsFeature = $productModel->getFeatureProducts();
$productsNew = $productModel->getNewProducts();
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                    <a href="index.php"><img class="img-fluid" src="admin/images/mobile-store-logo_8050-351.jpg" alt="logo images"></a>
                                </div>
                            </div>
                        ...
                        <div class="row align-items__center">
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        <h2>the most beautiful phone</h2>
                                        <h1>CHOOSE FREEDOM</h1>
                                        <div class="cr__btn">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="admin/images/iphone-12-didongviet-1.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="admin/images/7ed2383388.jpeg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">Sản Phẩm Nổi Bật</h2>
                            <p></p>
                        </div>
                    </div>
                </div>
                <div class="htc__product__container">
                    <div class="row">
                        <div class="product__list clearfix mt--30">
                            ...
                            <?php foreach ($productsFeature as $product) { ?>
                                    ...
                                    <div class="category">
                                        ...
                                        <div style="padding-top: 60px" class="fr__product__inner">
                                            ...
                                            <ul class="fr__pro__prize">
                                                <li><?php echo number_format($product['price']) ." VND" ?></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">Sản Phẩm Mới Nhất</h2>
                            <p></p>
                        </div>
                    </div>
                </div>
